...
namespace FSerialization {
    public static partial class TypeWrangler {
        public static class Serializer {
            public static Dictionary<string, Func<object, byte[]>> Serializers = new Dictionary<string, Func<object, byte[]>> {
                {
                    BYTE,
                    (o) => new[] { (byte)o }
                },
        ...
        public static class Deserializer {
            public static Dictionary<string, Func<byte[], int, object>> Deserializers = new Dictionary<string, Func<byte[], int, object>>() {
                {
                    BYTE,
                    (b, s) => {
                        return b[s];
